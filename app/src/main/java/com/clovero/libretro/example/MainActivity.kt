...
package com.clovero.libretro.example

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import clovero.libretro.example.R
import com.emulator.libretro.NativeLib
import java.io.File
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        NativeLib.testCore("${applicationInfo.nativeLibraryDir}/libcore.so", initRom().absolutePath)
        //val retro = Retross()
        //retro.loadCore("libcore.so")
